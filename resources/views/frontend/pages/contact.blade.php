...
@section('main-content')
	...
	<div class="map-section">
		<div id="myMap">
			<iframe src="https://maps.google.com/maps?q=Santack%20Estate&amp;t=k&amp;z=13&amp;ie=UTF8&amp;iwloc=&amp;output=embed" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
	<!--/ End Map Section -->
