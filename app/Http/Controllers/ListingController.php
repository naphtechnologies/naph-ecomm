...
class ListingController extends Controller
{
    public function index()
    {
        ...
        return view('backend.listing.index', compact('published_listings','unpublished_listings'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($isSuccess) {
            ...
            $listing->save();
            return redirect(route('listing.index'))->with('success', 'Listing Added!');
        } else {
    ...
    public function show($id)
    {
        ...
        return view('backend.listing.single-listing', compact('listing'));
    }
